...
import us.gravwith.android.SQLiteDbContract.LocalEntry;
...
//    private static SQLiteDatabase dbW;
 ...
 //   private static SQLiteDbHelper sInstance;
    ...
    private static final String SQL_CREATE_LIVE =
            ...
            "CREATE TABLE " + LiveEntry.TABLE_NAME + " (" +
                    LiveEntry._ID + PRIMARY_KEY + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_THREAD_ID  + INT_TYPE + UNIQUE_KEY + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_TOPIC_ARN  + TEXT_TYPE + UNIQUE_KEY + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_TIME + INT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_TITLE + TEXT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_NAME + TEXT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_DESCRIPTION + TEXT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_FILEPATH + TEXT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_REPLIES + INT_TYPE + COMMA_SEP +
                    LiveEntry.COLUMN_NAME_UNIQUE + INT_TYPE +
                    " )";
    ...
    private final String SQL_DELETE_LIVE =
            "DROP TABLE IF EXISTS " + LiveEntry.TABLE_NAME;
