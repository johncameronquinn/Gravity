...
public class RequestLocalRunnable implements Runnable {
    ...
    public void run() {
        ...
        double lat = b.getDouble(SQLiteDbContract.LocalEntry.COLUMN_NAME_LATITUDE, 0.0);
        double lon = b.getDouble(SQLiteDbContract.LocalEntry.COLUMN_NAME_LONGITUDE, 0.0);
